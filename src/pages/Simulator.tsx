...
import { formatNumberBadge } from '../lib/stats';
import { evaluateBetStatScore } from '../lib/betScore';
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-surface-container border border-outline rounded-3xl p-5 md:p-8 shadow-sm space-y-6">
        <div className="flex items-center gap-3">
          <Target className="w-5 h-5 text-primary" />
          <h3 className="font-bold text-xl">Peso Estatistico do Jogo</h3>
        </div>
        <p className="text-sm text-on-surface-variant font-medium">
          Nota baseada no historico filtrado: combina paridade, soma, pares/trincas e sequencias recorrentes.
        </p>
        ...
        {selectedBet ? (
          <>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white border border-outline p-5 rounded-2xl shadow-sm">
                <p className="text-[10px] font-extrabold text-on-surface-variant uppercase tracking-widest mb-1">Score Tecnico</p>
          ...
          <p className="text-on-surface-variant text-sm">Selecione um jogo para calcular o peso estatistico.</p>
        )}
      </section>
